...
export class App extends Component {
  //we need a user in our state taht will be changed on whether or not a user is logged in or not
  state = {
    user: null,
  };
  ...
  //we render from <mainrouter component to allow for the logged in or out functioanlity. MainRouter.js provides what we need for the maninrouter div below
  render() {
    return (
      <>
